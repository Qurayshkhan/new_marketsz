...
@section('content')
    <section class="container pt-12 space-y-12 sm:pt-20" id="meettheteam">
        <header class="max-w-2xl px-4 mx-auto text-center sm:pt-20">
            <div class="px-4 pb-20 sm:px-0">
                <div class="mx-auto text-center">
                    <h3 class="text-3xl font-bold mb-4">Contact Marketsz</h3>
                    <p class="text-sm text-gray-600">Contact us today through our livechat or send us an email at <a href="mailto:support@marketsz.com" class="text-primary">support@marketsz.com</a></p>
